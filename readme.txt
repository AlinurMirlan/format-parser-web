Конвертирование пакета из PCMS2 в KRSU (База) [+]
Конвертирование пакета из EJUDGE в KRSU [+]
Конвертирование пакета из CATS в KRSU [+]
Подгрузка новых модулей через web-приложение [+]
...
Описание блиблотек модулей преобразований FormatConverter.Module.CatsToKrsu
				    		  EjudgeToKrsu
						  Pcms2ToKrsu
...
test-format-files - папка где находятся файлов форматов, на которых текстировалось приложение.

Проект также доступен в Github: https://github.com/AlinurMirlan/format-parser-web
